pimcore.registerNS('SocialData.Connector.LinkedIn');
SocialData.Connector.LinkedIn = Class.create(SocialData.Connector.AbstractConnector, {
    ...
    beforeDisableFieldState: function (stateType, toDisableState) {
        ...
        if (stateType === 'connection' && toDisableState === false) {
            return !(
                this.customConfiguration.hasOwnProperty('clientId') &&
                this.customConfiguration.hasOwnProperty('clientSecret')
            );
        }
    ...
    connectHandler: function (stateType, mainBtn) {
        ...
        var win = new Ext.Window({
            ...
            title: t('social_data.connector.linkedin.connect_service'),
            html: t('social_data.connector.linkedin.connect_service_note'),
            listeners: {
            ...
            buttons: [
                {
                    text: t('social_data.connector.linkedin.connect'),
    ...
    handleConnectWindow: function (mainBtn, btn) {
        ...
        connectWindow = new SocialData.Component.ConnectWindow(
            '/admin/social-data/connector/linkedin/connect',
            // success
            function (stateData) {
    ...
    getCustomConfigurationFields: function () {
        ...
        return [
            ...
            },
            {
                ...
                allowBlank: false,
                value: data.hasOwnProperty('clientId') ? data.clientId : null
            },
            {
                trackResetOnLoad: true,
                xtype: 'textfield',
                ...
                allowBlank: false,
                value: data.hasOwnProperty('clientSecret') ? data.clientSecret : null
            },
            {
                xtype: 'button',
                text: 'Debug Token',
                ...
                handler: function () {
                    Ext.Ajax.request({
                        url: '/admin/social-data/connector/linkedin/debug-token',
                        method: 'GET',
